...
void printScores(int[] dices)
{
    ...
    IO.println("1. " + names[0] + ": " + calculateScore(dices, 1));    
    IO.println("2. " + names[1] + ": " + calculateScore(dices, 2));
    IO.println("3. " + names[2] + ": " + calculateScore(dices, 3));
    IO.println("4. " + names[3] + ": " + calculateScore(dices, 4));
    IO.println("5. " + names[4] + ": " + calculateScore(dices, 5));
    IO.println("6. " + names[5] + ": " + calculateScore(dices, 6));
    IO.println("7. " + names[6] + ": " + calculateScore(dices, 7));
    IO.println("8. " + names[7] + ": " + calculateScore(dices, 8));
    IO.println("9. " + names[8] + ": " + calculateScore(dices, 9));
    IO.println("10. " + names[9] + ": " + calculateScore(dices, 10));    
}
