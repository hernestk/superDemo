...
public class FireworkExplosion extends Explosion {
    public FireworkExplosion(double xPosition, double yPosition) {
    ...
    protected void generateParticles(double xPosition, double yPosition) {
        ...
        System.out.println("FIREWORK!"); // added this extra line to tell you what's generated.
    }
}
